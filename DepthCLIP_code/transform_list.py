...
class RandomColor(object):
    ...
    def __init__(self, multiplier_range=(0.9, 1.1), brightness_mult_range=(0.75, 1.25), random_state=np.random, dataset = 'KITTI'):
...
class RandomScaleCrop(object):
    ...
    def __call__(self, images):
        ...
        scaled_images = [scipy.misc.imresize(im, (scaled_h, scaled_w)) for im in images]
